    ...
    public function cadastrar()
    {
        ...
        if (isset($formulario)) {
            ...
            $dados = [
                ...
                'txtDataTreinamento' => trim($formulario['txtDataTreinamento']),
                'txtHoraTreinamento' => trim($formulario['txtHoraTreinamento']),
                'txtDataLive' => trim($formulario['txtDataLive']),
                'txtHoraLive' => trim($formulario['txtHoraLive']),
